  ...
  return (
    <section id="what-we-offer" className={styles.whatWeOffer}>
      <div className={styles.offerItem}>
        <h2>Explore AI Opportunities for Your Enterprise <i class="fa-brands fa-wpexplorer"></i></h2>
      ...
      <div className={styles.offerItem}>
        <h2>Design AI Trust Layer <i class="fa-regular fa-handshake"></i></h2>
      ...
      <div className={styles.offerItem}>
        <h2>Scalability-Focused Solutions <i class="fa-solid fa-gears"></i></h2>
      ...
      <div className={styles.offerItem}>
        <h2>End to end Workflow automation <i class="fa-solid fa-arrow-turn-up"></i></h2>
