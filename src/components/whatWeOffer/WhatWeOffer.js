  ...
  return (
    <section id="what-we-offer" className={styles.whatWeOffer}>
      <div className={styles.offerItem}>
        <h2>Explore AI Opportunities for Your Enterprise <i className="fa-brands fa-wpexplorer"></i></h2>
      ...
      <div className={styles.offerItem}>
        <h2>Design AI Trust Layer <i className="fa-regular fa-handshake"></i></h2>
      ...
      <div className={styles.offerItem}>
        <h2>Scalability-Focused Solutions <i className="fa-solid fa-gears"></i></h2>
      ...
      <div className={styles.offerItem}>
        <h2>End to end Workflow automation <i className="fa-solid fa-arrow-turn-up"></i></h2>
